...
async function shareRoom(useNavigator = false) {
    ...
    function share() {
        ...
        Swal.fire({
            ...
            <p style="background:whitesmoke; color:black; font-family: Arial, Helvetica, sans-serif;">No need for apps, simply capture the QR code with your mobile camera Or Invite someone else to join by sending them the following URL</p>
        ...
        preConfirm: () => {
            ...
            const roomPassword =
                isRoomLocked && (room_password || rc.RoomPassword)
                    ...
                    : '';
            const email = '';
            const emailSubject = `Please join our Video Dialling Video Chat Meeting`;
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Video Dialling experience?',
